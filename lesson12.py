...
def process_image(image_path: Path):
    ...
    try:
        ...
        # Enrich each band with genre and country using the second agent
        enriched_bands: list[EnrichedBandInfo] = []
        ...
        enriched_extraction = EnrichedConcertExtraction(bands=enriched_bands)
