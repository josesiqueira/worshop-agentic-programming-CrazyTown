r"""
Lesson 8: Introducing Pydantic AI agentic framework - Quickly switch between Anthropic and OpenAI

Can we ask: What are all the genres in the database?
What are all the bands of the genre post punk?
